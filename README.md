...
Процесс установки и настройки описан [здесь](https://ya360.readthedocs.io/ru/3.1.2/befo.html)

Документация на [ya360.readthedocs.io](https://ya360.readthedocs.io/ru/3.1.2), но она вряд ли вам нужна, если знаете как пользоваться командой:
